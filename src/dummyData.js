export const homeData = [
  {
    ...
    rating: 4.7,
    time: "2hr : 22mins",
    desc: "Las tormentas de arena y polvo (SDS), también conocidas como siroco, haboob, polvo amarillo, tormentas blancas y harmattan, son un fenómeno natural relacionado con la gestión de la tierra y el agua y el cambio climático..",
  ...
  },
  {
    ...
    rating: 4.6,
    time: "2hr : 22mins",
    desc: "La isla, al igual que sus habitantes, es totalmente ficticia. La isla natal de Kong en el Pacífico hace su primera aparición, junto con el propio Kong, en la película King Kong de 1933.",
